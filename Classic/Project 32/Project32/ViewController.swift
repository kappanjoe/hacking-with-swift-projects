...
//  Project32
//
//  Created by Joseph Van Alstyne on 11/16/22.
//
...
class ViewController: UITableViewController {
    ...
    // See Project 12 for an example of how to implement a custom class instead of simple arrays
    ...
    override func viewDidLoad() {
        ...
        // notificationCenter.addObserver(self, selector: #selector(reloadCells), name: UIContentSizeCategory.didChangeNotification, object: nil)
...
// ---------- Refresh UI on Dynamic Type size change
//    @objc func reloadCells(notification: Notification) {
...
//    }
    ...
    func index(item: Int) {
        ...
        // Items expire after one month by default; regularly update or set to distant future
    ...
    func makeAttributedString(title: String, subtitle: String) -> NSAttributedString {
        ...
        // titleString uses NSMutableAttributedString to allow appending subtitle
