...
class ViewController: UITableViewController, NSFetchedResultsControllerDelegate {
	...
	// attribute constraints are only enforce upon save - be aware that controller may hold duplicates until a save takes place
    ...
    override func viewDidLoad() {
		...
		// 2. Creates NSPersistentStoreCoordinator object for read/write
		// 3. Sets up URL pointed to SQLite database file
		// 4. Loads database file into NSPersistentStoreCoordinator
		// 5. Creates NSManagedObjectContext pointed at NSPersistentStoreCoordinator
